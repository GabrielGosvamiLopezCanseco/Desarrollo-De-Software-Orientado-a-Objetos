...
"""
    ...
    def guardar(self, db: DatabaseManager) -> bool:
        try:
            ...
            """, (self.id, self.pedido_id, self.fecha_emision, self.subtotal, self.iva, self.total, self.estatus))
    ...
    def actualizar_estado_pedido(self, pedido_id):
        ...
        try:
            ...
            self.db.cursor.execute("""
                INSERT INTO Factura (id, pedido_id, fecha_emision, subtotal, iva, total, estatus)
                VALUES (%s, %s, %s, %s, %s, %s, %s)
            """, (f"F{pedido_id}", pedido_id, fecha_actual, self.subtotal, self.iva, self.total, 'EMITIDA'))
